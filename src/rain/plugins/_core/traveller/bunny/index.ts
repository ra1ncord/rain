...
export const pluginRepositories = createStorage<t.PluginRepoStorage>("pyonplugins/repositories.json");
export const pluginSettings = createStorage<t.PluginSettingsStorage>("pyonplugins/settings.json");
