...
// Default export is React.memo(StickerDetailActionSheet); patch the inner fn via its .type.
const StickerDetailSheet = findByFilePathLazy("modules/stickers/native/StickerDetailActionSheet.tsx", true);

export function patchStickerActionSheet() {
    return instead("type", StickerDetailSheet, (componentArgs: any[], original: any) => {
