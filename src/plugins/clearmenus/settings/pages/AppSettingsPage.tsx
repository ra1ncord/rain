        ...
        <ReactNative.ScrollView style={{ flex: 1, backgroundColor: semanticColors.BACKGROUND_PRIMARY }}>
            <Stack spacing={24} style={{ paddingVertical: 24, paddingHorizontal: 12 }}>
                <TableRowGroup title="App Settings">
                    ...
                    <TableSwitchRow label="Hide Web Browser" icon={<TableRow.Icon source={findAssetId("GlobeEarthIcon")} />} value={!!settingsSections.appSettings.WEB_BROWSER} disabled={!!settingsSections.appSettings.hideAll} onValueChange={v => settingsSections.updateSettings({ appSettings: { ...settingsSections.appSettings, WEB_BROWSER: v } })} />
