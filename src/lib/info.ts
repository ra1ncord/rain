...
export const CODEBERG = "https://codeberg.org/raincord/rain";
export const KOFI = "https://ko-fi.com/cocobo1";
export const GITHUB = "https://github.com/ra1ncord/rain";
export const DEVELOPERS = "https://raincord.dev/credits";
